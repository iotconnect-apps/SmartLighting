...
export class LookupService {
  ...
  getZonelookup(parentEntityId) {
    ...
    return this.httpClient.get<any>(this.apiServer.baseUrl + 'api/lookup/subentitylookup/' + parentEntityId).map(response => {
      return response;
    });

  }
  getZonelookupByType(parentEntityId, type) {

    return this.httpClient.get<any>(this.apiServer.baseUrl + 'api/lookup/subentitylookup/' + parentEntityId + '/'+ type).map(response => {
      return response;
    });
  ...
  getzoneonType(type, faciltyId) {
    ...
    return this.httpClient.get<any>(this.apiServer.baseUrl + 'api/lookup/subentitylookup/' + faciltyId + '/' + type).map(response => {
      return response;
    });
