...
export class LightService {
	...
	deleteLight(lightGuid) {


		return this.httpClient.put<any>(this.apiServer.baseUrl + 'api/device/delete/' + lightGuid, "").map(response => {
			return response;
		});
	}
    ...
    var timeZone = moment().utcOffset();
		var path='api/dashboard/getgeneratordetail/'+genraterGuid+'?currentDate='+currentDate+'&timeZone='+timeZone;
