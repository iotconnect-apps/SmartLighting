...
{
    public partial class devlightingContext : DbContext
    {
        public devlightingContext()
        {
        }

        public devlightingContext(DbContextOptions<devlightingContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<DeviceSetting> DeviceSetting { get; set; }
        ...
        public virtual DbSet<TelemetrySummaryDaywise22042020> TelemetrySummaryDaywise22042020 { get; set; }
        public virtual DbSet<TelemetrySummaryHourwise> TelemetrySummaryHourwise { get; set; }
        public virtual DbSet<TelemetrySummaryHourwise22042020> TelemetrySummaryHourwise22042020 { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<AdminRule>(entity =>
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__AdminRul__497F6CB428D8197D");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__Attribut__497F6CB49E3F6CF8");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__Company__497F6CB4A81E96E2");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__CompanyC__497F6CB4CA4D9EB9");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__Configur__497F6CB439CB9B08");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__Device__497F6CB4D51981B3");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__tmp_ms_x__497F6CB497061127");

                entity.Property(e => e.Guid)
                    .HasColumnName("guid")
                    .ValueGeneratedNever();

                entity.Property(e => e.AmTime)
                    .HasColumnName("amTime")
                ...
                entity.Property(e => e.Dimming).HasColumnName("dimming");

                entity.Property(e => e.IntensityOff).HasColumnName("intensityOff");

                entity.Property(e => e.IntensityOn).HasColumnName("intensityOn");
                ...
                entity.Property(e => e.PmTime)
                    .HasColumnName("pmTime")
                    .HasColumnType("time(0)");

                entity.Property(e => e.PresenceTime).HasColumnName("presenceTime");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__IOTConne__497F6CB46ADE6C5A");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__KitTypeA__497F6CB4A6DFCCCE");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__MasterWi__A2B5777C4FDACC78");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__Module__497F6CB449BA4E85");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__RoleModu__497F6CB40C78AD2A");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__Telemetr__497F6CB45FC1839B");
            ...
            modelBuilder.Entity<TelemetrySummaryDaywise22042020>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("TelemetrySummary_Daywise_22042020");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__Telemetr__497F6CB4C8AFF617");
            ...
            modelBuilder.Entity<TelemetrySummaryHourwise22042020>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("TelemetrySummary_Hourwise_22042020");
            ...
            {
                entity.HasKey(e => e.Guid)
                    .HasName("PK__UserDasb__A2B5777CE64FA25B");
