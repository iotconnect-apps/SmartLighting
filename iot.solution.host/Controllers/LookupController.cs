...
namespace host.iot.solution.Controllers
{
    ...
    public class LookupController : BaseController
    {
       ...
       // base.LogException(ex);
        ...
        [EnsureGuidParameterAttribute("entityId", "Building")]
        ...
        [EnsureGuidParameterAttribute("subentityId", "Wing")]
        ...
        public Entity.BaseResponse<List<Entity.AttributeItem>> GetDeviceAttributeLookup(string deviceId)
        {
            ...
            try
            {
                response.Data = _service.DeviceAttributeLookup(Guid.Parse(deviceId));
            }
            catch (Exception ex)
            {
                base.LogException(ex);
