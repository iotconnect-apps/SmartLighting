...
001	SSES-2 27-02-2020 [Nishit Khakhi]	Added Initial Version to Update Device Maintenance Status
	...
	BEGIN TRY		
		...
		BEGIN TRAN
			...
			SET [description] = ISNULL(@description,[description])
				,[startDateTime] = ISNULL(@startDate,[startDateTime])
				,[endDateTime] = ISNULL(@endDate,[endDateTime])
