...
namespace iot.solution.service.Data
{
    public class LookupService : ILookupService
    {
        ...
        public List<Entity.LookupItemWithStatus> FacilityLookup(Guid companyId)
        {
            ...
            var template = _entityRepository.FindBy(t => t.CompanyGuid == companyId).FirstOrDefault();
            if (template != null)
            {
        ...
        public List<Entity.AttributeItem> DeviceAttributeLookup(Guid deviceId)
        {
            List<Entity.AttributeItem> result = new List<Entity.AttributeItem>();
            try
            {
                ...
                using (var sqlDataAccess = new SqlDataAccess(ConnectionString))
                {
                    ...
                    result = DataUtils.DataReaderToList<Entity.AttributeItem>(dbDataReader, null);
